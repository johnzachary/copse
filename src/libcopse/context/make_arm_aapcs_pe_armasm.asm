...
; * *****************************************************************/
    ...
    AREA |.text|, CODE
    ALIGN 4
    EXPORT cps_context_new_from_sp
    IMPORT _exit

cps_context_new_from_sp PROC
    mov     a4, a1          ; save address of context stack (base) A4
    sub     a1, a1, #116    ; reserve space for cps_context at top of context stack

    ; shift address in A1 to lower 16 byte boundary
    ; == pointer to cps_context and address of context stack
    bic     a1, a1, #15

    str     a4, [a1,#44]    ; save address of context stack (base) in cps_context
    str     a2, [a1,#48]    ; save context stack size in cps_context
    str     a3, [a1,#40]    ; save address of context function in cps_context

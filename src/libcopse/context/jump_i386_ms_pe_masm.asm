...
cps_context_jump PROC EXPORT
    mov     ecx,         [esp+04h]   ; load address of the first cps_context arg
    ...
    mov     edx,        [esp+08h]    ; load address of the second cps_context arg
